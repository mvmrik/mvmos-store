...
(function () {
  var STRINGS = {
    en: {
      ...
      tk_stop_hint:                 'Continue keeps the timer running, Discard throws the time away, Save completes the task.',
    ...
    bg: {
      ...
      tk_stop_hint:                 'Продължи пуска брояча отново, Отмени изтрива времето, Запази изпълнява задачата.',
