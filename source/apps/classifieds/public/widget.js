...
function mount(root, options = {}) {
  ...
  root.addEventListener('click',async e=>{
    ...
    try {
      ...
      else if(action==='browse'||action==='mine'||action==='watched') {if(action!=='browse'&&!requireLogin())return;mine=action==='mine';watched=action==='watched';offset=0;await load();}
