(function(){
  ...
  let ready;
  const assets=()=>ready||(ready=Promise.all([load('/apps/classifieds/i18n.js?v=1.7.0'),load('/apps/classifieds/widget.js?v=1.7.0')]).catch(e=>{ready=null;throw e;}));
  const css=document.createElement('link');css.rel='stylesheet';css.href='/apps/classifieds/style.css?v=1.7.0';document.head.appendChild(css);
