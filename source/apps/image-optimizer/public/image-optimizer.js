(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .io-controls{display:grid;grid-template-columns:minmax(260px,1fr) 250px;gap:16px;margin-bottom:12px}.io-drop{min-height:180px;border:2px dashed var(--pub-border,var(--border,#585b70));border-radius:14px;display:flex;align-items:center;justify-content:center;text-align:center;padding:20px;box-sizing:border-box;cursor:pointer;background:var(--pub-surface1,var(--surface1,#181825));transition:.16s border-color,.16s background,.16s transform;position:relative;overflow:hidden}.io-drop:hover,.io-drop:focus,.io-drop.drag{border-color:var(--pub-accent,var(--accent,#89b4fa));background:color-mix(in srgb,var(--pub-accent,var(--accent,#89b4fa)) 9%,var(--pub-surface1,var(--surface1,#181825)));outline:none}.io-drop.drag{transform:scale(.995)}.io-drop-icon{font-size:34px;margin-bottom:7px}.io-drop-title{font-size:16px;font-weight:700}.io-drop-hint{font-size:12px;color:var(--pub-fg2,var(--fg2,#a6adc8));margin-top:4px}.io-progress-track{height:4px;background:var(--pub-surface2,var(--surface2,#313244));position:absolute;inset:auto 0 0}.io-progress{height:100%;width:0;background:var(--pub-accent,var(--accent,#89b4fa));transition:width .2s}
      .io-panel,.io-premium{border:1px solid var(--pub-border,var(--border,#45475a));border-radius:14px;background:var(--pub-surface1,var(--surface1,#181825));padding:15px}.io-panel{display:flex;flex-direction:column;gap:12px}.io-field{display:flex;flex-direction:column;gap:5px}.io-field label,.io-label{font-size:12px;color:var(--pub-fg2,var(--fg2,#a6adc8));font-weight:600}.io-field select,.io-field input[type=text],.io-field input[type=number]{width:100%;box-sizing:border-box;padding:8px 10px;border:1px solid var(--pub-border,var(--border,#45475a));border-radius:8px;background:var(--pub-surface2,var(--surface2,#313244));color:inherit;font:inherit}.io-quality-row{display:grid;grid-template-columns:1fr 44px;gap:9px;align-items:center}.io-quality-row input{accent-color:var(--pub-accent,var(--accent,#89b4fa));width:100%}.io-quality-value{text-align:right;font-weight:700}.io-actions{display:flex;flex-direction:column;gap:7px;margin-top:auto}
      ...
      .io-errors{display:flex;flex-direction:column;gap:6px;margin-bottom:12px}.io-error{border:1px solid color-mix(in srgb,var(--pub-red,var(--red,#f38ba8)) 45%,transparent);background:color-mix(in srgb,var(--pub-red,var(--red,#f38ba8)) 10%,transparent);color:var(--pub-red,var(--red,#f38ba8));border-radius:8px;padding:8px 10px;font-size:12px}.io-results{border:1px solid var(--pub-border,var(--border,#45475a));border-radius:14px;background:var(--pub-surface1,var(--surface1,#181825));overflow:hidden}.io-empty{text-align:center;padding:38px 16px;color:var(--pub-fg2,var(--fg2,#a6adc8))}.io-table-wrap{overflow-x:auto}.io-table{width:100%;border-collapse:collapse;min-width:720px}.io-table th{padding:9px 12px;text-align:left;font-size:11px;text-transform:uppercase;letter-spacing:.04em;color:var(--pub-fg2,var(--fg2,#a6adc8));background:var(--pub-surface2,var(--surface2,#313244))}.io-table td{padding:10px 12px;border-top:1px solid var(--pub-border,var(--border,#45475a));vertical-align:middle}.io-thumb{width:52px;height:52px;object-fit:cover;border-radius:8px;display:block;background:#111;cursor:pointer}.io-name{max-width:300px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:600}.io-sub{font-size:11px;color:var(--pub-fg2,var(--fg2,#a6adc8));font-weight:400}.io-saving{font-weight:700;color:var(--pub-green,var(--green,#a6e3a1))}.io-saving.grew{color:var(--pub-warning,var(--warning,#f9e2af))}.io-status{font-size:12px;color:var(--pub-fg2,var(--fg2,#a6adc8));margin:0 0 9px}.io-hidden{display:none!important}
