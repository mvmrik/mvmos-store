...
_DIR        = os.path.dirname(__file__)                                    # backend/apps/shoppinglist
_DB_PATH    = os.path.join(_DIR, "..", "..", "..", "apps", "shoppinglist", "data.db")
_PUBLIC_DIR = os.path.join(_DIR, "..", "..", "..", "apps", "shoppinglist", "public")
